...
const struct bpf_func_proto bpf_htm_begin_proto = {
        .func           = bpf_htm_begin,
        .gpl_only       = false,
        .ret_type       = RET_INTEGER, // ret_integer ou ret_void?
};
...
const struct bpf_func_proto bpf_htm_abort_proto = {
        .func           = bpf_htm_abort,
        .gpl_only       = false,
        .ret_type       = RET_INTEGER, // ret_integer ou ret_void?
};
...
const struct bpf_func_proto bpf_htm_end_proto = {
        .func           = bpf_htm_end,
        .gpl_only       = false,
        .ret_type       = RET_VOID, // ret_integer ou ret_void?
};
...
bpf_base_func_proto(enum bpf_func_id func_id)
{
	...
	case BPF_FUNC_htm_begin:
		return &bpf_htm_begin_proto;
	case BPF_FUNC_htm_abort:
                return &bpf_htm_abort_proto;
	case BPF_FUNC_htm_end:
                return &bpf_htm_end_proto;

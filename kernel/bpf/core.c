...
const struct bpf_func_proto bpf_htm_begin_proto __weak;
const struct bpf_func_proto bpf_htm_abort_proto __weak;
const struct bpf_func_proto bpf_htm_end_proto __weak;
